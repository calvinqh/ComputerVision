...
namespace Programs {
  ...
  //Thresholds the edge "strength" image, removes all weak edges
  ...
  //@param edge_image: edge strength image for an image
  ...
  void LineDetection(Image* original_image, vecotor<vector<int>> voting_array, int threshold, Image* out_image);
